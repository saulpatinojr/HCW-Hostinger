...
| [0004](./adr/0004-terraform-for-inventory-not-vps.md) | Terraform manages the Ansible inventory, not the VPS *(superseded by 0018)* |
...
| [0018](./adr/0018-terraform-owns-the-vps.md) | Terraform owns the VPS and the SSH key installed on it *(supersedes 0004)* |
